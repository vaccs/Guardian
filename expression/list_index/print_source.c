	...
	struct out_shared* shared)
{
	...
	stringtree_append_printf(tree, "type_%u* _list = ", list_type->id);
	...
	stringtree_append_printf(tree, "type_%u* _index = ", index_type->id);
	...
	stringtree_append_printf(tree, ""
		"type_%u* _element = func_%u(_list, _index);"
	...
	stringtree_append_printf(tree, ""
		"func_%u(_list), func_%u(_index);"
	"", free_list_id, free_index_id);
	
	stringtree_append_printf(tree, "_element;");
